...
from telegram_alert import send_test_ding, start_telegram_watcher
...
class Handler(SimpleHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if path == "/api/telegram/test-ding":
            self._telegram_test_ding()
            return
    ...
    def _telegram_test_ding(self) -> None:
        try:
            send_test_ding()
